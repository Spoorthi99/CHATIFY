...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  Widget _nameTextField() {
    return TextFormField(
      ...
      validator: (_input) {
        return _input.length != 0 ? null : "Please enter valid name";
      },
      onSaved: (_input) {
        setState(() {
          _name = _input;
                ...
                if (_formKey.currentState.validate() ) {
                  _auth.registerUserWithEmailAndPassword(_email, _password,
                    ...
                    await DBService.instance
                        .createUserInDB(_uid, _name, _email, "https://cdn0.iconfinder.com/data/icons/occupation-002/64/programmer-programming-occupation-avatar-512.png");
                  });
                }
              },
              color: Colors.blue,
